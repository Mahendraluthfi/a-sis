        ...
        success: function(data)
	        {
	            ...
	            for(i=0; i<data.length; i++){
	              ...
	              "<td><a href='datanilai/session/"+data[i].id_rombel+"/"+data[i].id_mapel+"/1' class='btn btn-success btn-sm'>Ganjil</a>&nbsp;<a href='datanilai/session/"+data[i].id_rombel+"/"+data[i].id_mapel+"/2' class='btn btn-success btn-sm'>Genap</a></td>"+                  
	              "</tr>";
        		}
	            $('#show').html(html);           
                $('#tb').DataTable({
