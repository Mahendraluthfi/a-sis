    	...
    	<div class="col-xs-12">
            ...
            <!-- /.box-header -->
            	<div class="box-body">
            		<?php
            		foreach ($isi as $row) {
            		echo form_open_multipart('daftar/edit_simpan/'.$row->id_daftar.'/'.$row->foto, array('class' => 'form-horizontal')); 
            		?>
		            	<div class="box-body">
		                	<div class="form-group">
			                  	...
			                  	<div class="col-sm-2">
			                    	<input type="text" name="tgldaftar" class="form-control" id="datepicker" placeholder="Tanggal Daftar" required="" value="<?php echo $row->tgl_daftar ?>">
			                  	</div>
		                	</div>
		                	<div class="form-group">
